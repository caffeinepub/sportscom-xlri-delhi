...
import type { ExternalBlob as _ExternalBlob, GalleryCategory as _GalleryCategory, GalleryImage as _GalleryImage, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addImage(arg0: GalleryImage): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addImage(await to_candid_GalleryImage_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getImagesByCategory(arg0: GalleryCategory): Promise<Array<GalleryImage>> {
        if (this.processError) {
            try {
                const result = await this.actor.getImagesByCategory(to_candid_GalleryCategory_n11(this._uploadFile, this._downloadFile, arg0));
                return from_candid_vec_n15(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateImage(arg0: GalleryImage): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateImage(await to_candid_GalleryImage_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_GalleryCategory_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _GalleryCategory): GalleryCategory {
    return from_candid_variant_n20(_uploadFile, _downloadFile, value);
}
async function from_candid_GalleryImage_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _GalleryImage): Promise<GalleryImage> {
...
async function from_candid_record_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        category: from_candid_GalleryCategory_n19(_uploadFile, _downloadFile, value.category),
...
function from_candid_variant_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    captainsAnnouncement: null;
} | {
    ratanjee: null;
}): GalleryCategory {
    return "xpl" in value ? GalleryCategory.xpl : "northernBrawl" in value ? GalleryCategory.northernBrawl : "captainsAnnouncement" in value ? GalleryCategory.captainsAnnouncement : "ratanjee" in value ? GalleryCategory.ratanjee : value;
}
...
async function from_candid_vec_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_GalleryImage>): Promise<Array<GalleryImage>> {
    return await Promise.all(value.map(async (x)=>await from_candid_GalleryImage_n16(_uploadFile, _downloadFile, x)));
}
...
function to_candid_GalleryCategory_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: GalleryCategory): _GalleryCategory {
...
async function to_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        imageLabel: value.imageLabel,
        category: to_candid_GalleryCategory_n11(_uploadFile, _downloadFile, value.category),
        orderIndex: value.orderIndex
    };
}
function to_candid_variant_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: GalleryCategory): {
    xpl: null;
} | {
    northernBrawl: null;
} | {
    ...
    return value == GalleryCategory.xpl ? {
        xpl: null
    } : value == GalleryCategory.northernBrawl ? {
        northernBrawl: null
    } : value == GalleryCategory.captainsAnnouncement ? {
        captainsAnnouncement: null
    } : value == GalleryCategory.ratanjee ? {
        ratanjee: null
    } : value;
}
